####################
#generating SIMPLE EXAMPLE similar to the results in Figure 4 
library(nnet)
...
#
############################
# SIMPLE EXAMPLE half violin plots similar to that in Figure 4
grid.arrange(p4_1,p4_2,p4_3)


#################
#SIMPLE EXAMPLE Table in similar to that in Figure 4
#logistic
table_1
#random forest
table_2
